...
A solution to the problem below:
...
cost of the items, and the total amounts of sales taxes paid. The rounding rules for sales tax are that for a tax rate of n%, a shelf
...
The program is written with Java 8 JDK.

========================
Running the application:
========================

In command line,change directory into the project folder and execute the following:
